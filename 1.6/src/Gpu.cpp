...
Words Gpu::stage2(const Words& x, const Stage2Plan& plan, u32 reportEvery,
  ...
  // T_j = x^(j^2). Direct exponentiation: a few thousand multiplies in total
  // against millions in the main loop, and it keeps this independent of the
  // A/S recurrence so a bug in one cannot hide a bug in the other.
  //
