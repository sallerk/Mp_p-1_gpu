...
// Declared in common.h. Upstream defines it in tune.cpp, which is not part of
// this program (52 KB of PRP tuning logic with its own dependency tail), so the
// definition lives here with the other common.h utilities.
