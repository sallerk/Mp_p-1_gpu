...
#ifdef _MSC_VER
#include <intrin.h>   // _umul128, used by Z61::_mul below
#endif
...
private:
        ...
        {
                // The full 128-bit product of two 61-bit values, folded back
                // into GF(2^61-1). MSVC has no __uint128_t; _umul128 gives the
                // same two halves.
#ifdef _MSC_VER
                uint64_t hi;
